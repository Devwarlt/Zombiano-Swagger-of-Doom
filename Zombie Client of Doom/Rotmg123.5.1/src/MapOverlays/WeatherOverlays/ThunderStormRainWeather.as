...
public class ThunderStormRainWeather extends MapOverlay {

    public var _P_j:Vector.<RainDrop>;
    protected var graphicsData_:Vector.<IGraphicsData>;
    private var time:int;

    public function ThunderStormRainWeather(){
        this._P_j = new Vector.<RainDrop>();
    ...
    private function addRainDrop():void{
        ...
        var _local2:RainDrop = new RainDrop(((Math.random() * 1000) - 500), ((Math.random() * 1000) - 500), (4 * (0.5 + (0.5 * Math.random()))), _local1._W_u[int((_local1._W_u.length * Math.random()))]);
        _local2.x_spd = 7;
        _local2.y_spd = 7;
...
class RainDrop {
    ...
    public function RainDrop(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:BitmapData):void{

...
public class SnowWeather extends MapOverlay {

    public var _P_j:Vector.<SnowStar>;
    protected var graphicsData_:Vector.<IGraphicsData>;
    private var time:int;

    public function SnowWeather(){
        this._P_j = new Vector.<SnowStar>();
    ...
    private function addSnowStar():void {
        ...
        var _local2:SnowStar = new SnowStar(((Math.random() * 1000) - 500), ((Math.random() * 1000) - 500), (4 * (0.5 + (0.5 * Math.random()))), _local1._W_u[int((_local1._W_u.length * Math.random()))]);
...
class SnowStar {
    ...
    public function SnowStar(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:BitmapData):void{

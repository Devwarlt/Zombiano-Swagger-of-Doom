...
public class AdditionalStats extends Sprite {
    ...
    public function AdditionalStats(_arg1:int, _arg2:int) {
        var _local3:XML;
        var _local4:Stat;
        ...
        var _xj:XML = <Stats>
            <Stat>
                ...
                <Description>This is the ammunition in your magazine from your current weapon.</Description>
                <RedOnZero/>
            </Stat><!--
            <Stat>
                <Abbr>DEF</Abbr>

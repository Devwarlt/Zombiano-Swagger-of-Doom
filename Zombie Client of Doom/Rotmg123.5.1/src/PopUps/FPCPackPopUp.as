...
public class FPCPackPopUp extends PopUpScreen {
    ...
    public function FPCPackPopUp(gameSprite:GameSprite, packType:int, sound:LocalSound) {
        ...
        switch (packType) {
            case 0:
                this.packIcon.bitmapData = new AccountManagementImages.bronzeFpcPack().bitmapData;
                this.packName.text = "Bronze FPC Pack";
                break;
            case 1:
                this.packIcon.bitmapData = new AccountManagementImages.silverFpcPack().bitmapData;
                this.packName.text = "Silver FPC Pack";
                break;
            case 2:
                this.packIcon.bitmapData = new AccountManagementImages.goldFpcPack().bitmapData;
                this.packName.text = "Gold FPC Pack";
                break;
            case 3:
            default:
                this.packIcon.bitmapData = new AccountManagementImages.premiumFpcPack().bitmapData;
                this.packName.text = "Premium FPC Pack";
                break;
        }

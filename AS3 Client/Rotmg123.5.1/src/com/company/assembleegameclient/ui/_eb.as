...
package com.company.assembleegameclient.ui{
    ...
    public class _eb extends Sprite {
        ...
        public function _07t(_arg1:int):void{
            ...
            {
                case _0G_E_:
                    this.nameText_._gp(0xB3B3B3);
                    this.taglineText_._gp(0xB3B3B3);
                    this.taglineText_.text = "Click items you want to trade";
                    this.taglineText_.updateMetrics();
                    return;
                case _fo:
                    this.nameText_._gp(0xFF0000);
                    this.taglineText_._gp(0xFF0000);
                    this.taglineText_.text = "Not enough space for trade!";
                    this.taglineText_.updateMetrics();
                    return;
                case _Q_p:
                    this.nameText_._gp(9022300);
                    this.taglineText_._gp(9022300);
